...
<xsl:transform version="1.0"
	...
	<xsl:template match="/" priority="1">
		<!-- Jeffrey addition for numbered lists 1,1.1,1.2,... -->
		<style type="text/css">
			#alignh1{
			float:right;
			width:51%;
		...
		<html>
			...
			<body class="spl" id="spl">
				...
				<xsl:if test="boolean($show-data)">
					<div class="DataElementsTables"></div>
				</xsl:if>
	...
	<xsl:template mode="title" match="v3:document">
		<div class="DocumentTitle">
			<p class="DocumentTitle">
				...
				<!-- Jason / Jeffrey Addition -->
				<p style="font-size:1.5em; text-align:center;"> PRODUCT MONOGRAPH </p>
				<br />
				<p style="font-size:1.5em; text-align:center;"> INCLUDING PATIENT MEDICATION INFORMATION </p>
				<br />
				<br />
				<span class='formHeadingTitle'>
				<h2 style="text-align:center;">
					<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section[@ID='L79d35375-0da3-429d-b858-bba36a4252e7']/v3:code">
						<xsl:value-of select="@displayName"/> &#160;
						<xsl:choose>
					...
					<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:code/@code='12']/v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:name">
					<xsl:copy>
							<xsl:value-of select="." />
					</xsl:copy>
					<xsl:choose>
				...
				<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:code/@code='12']/v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:asEntityWithGeneric/v3:genericMedicine/v3:name">
					<xsl:copy>
				<xsl:value-of select="."/>
			</xsl:copy>
				<xsl:choose>
			...
			<br/>
				...
				<p style="font-size:1.5em; text-align:center;"><xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:formCode/@code='2']/v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:formCode/@displayName"/>
				<xsl:choose>
				<xsl:when test="v3:component/v3:structuredBody/v3:component[v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:code/@code='12']/v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:ingredient/v3:quantity/v3:numerator/@value[@value!='0'] ">
				,
				<xsl:copy><xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:code/@code='12']/v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:ingredient/v3:quantity/v3:numerator/@value"/> ,
			</xsl:copy>
			 </xsl:when>
			 <xsl:otherwise/>
		 </xsl:choose>,
		 ...
		 <xsl:if test="v3:quantity/v3:numerator/@value !='0'">
			 <xsl:copy>
			 <xsl:value-of select="v3:ingredientSubstance/v3:name"/>,
		 </xsl:copy>
		 </xsl:if>
		 <xsl:if test="not(v3:quantity)">
			 <xsl:copy>
		 <xsl:value-of select="v3:ingredientSubstance/v3:name"/>,
	 </xsl:copy>
	 </xsl:if>
		 ...
		 <xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:subject/v3:manufacturedProduct/v3:consumedIn/v3:substanceAdministration/v3:routeCode]/v3:section/v3:subject/v3:manufacturedProduct/v3:consumedIn/v3:substanceAdministration/v3:routeCode">
			 <xsl:copy>
		 <xsl:value-of select="@displayName"/></xsl:copy>
	 </xsl:for-each>
				...
				<h2>
				<xsl:choose>
					<xsl:when test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@codeSystem='2.16.840.1.113883.3.989.5.1.4.1.5']/v3:section/v3:code/@displayName != ''">
				<p style="text-align:center;">
					<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@codeSystem='2.16.840.1.113883.3.989.5.1.4.1.5']/v3:section/v3:code">
					<xsl:value-of select="@displayName"/>
				</xsl:for-each>
					</p>
			</xsl:when>
			<xsl:otherwise>
				<p style="text-align:center;"> Pharmaceutical Standard not Applicable </p>
			</xsl:otherwise>
		</xsl:choose>
				<br />
				<p style="text-align:center;">
					<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='A01AB03']/v3:section/v3:code">
					<xsl:value-of select="@displayName" />
					<xsl:choose>
						<xsl:when test="position() != last()">, </xsl:when>
					</xsl:choose>
				...
				<br />
				<br />
				<p style="text-align:left; "><xsl:value-of select="v3:author/v3:assignedEntity/v3:representedOrganization/v3:name" /> </p>
				<p style="text-align:left; ">
					<xsl:for-each select="v3:author/v3:assignedEntity/v3:representedOrganization/v3:contactParty/v3:addr">
						<xsl:copy>

						<xsl:value-of select="v3:streetAddressLine"/>,
						<xsl:value-of select="v3:city"/>, <xsl:value-of select="v3:state"/>,
					...
					<span style="font-size:1em; float:right;">
						<xsl:copy>
						<xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='150']/v3:section/v3:code/@displayName" />
					</xsl:copy>
					</span> <br/>
				<span style="font-size:1em; float:right;">
					<xsl:copy>
						<xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='150']/v3:section/v3:text" /></xsl:copy>
			</span> </p><br/>
				<p style="text-align:left; ">
					<span style="visibility:hidden;">.</span> <span style="font-size:1em; float:right;"> or </span> </p>
				<p style="text-align:left; "> <span style="visibility:hidden;">.</span> <span style="font-size:1em; float:right;">
				<xsl:copy>
				<xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='160']/v3:section/v3:code/@displayName" />
			</xsl:copy>
			</span> </p>
				<span style="visibility:hidden;">.</span> <span style="font-size:1em; float:right;">
				<xsl:copy>
				<xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='160']/v3:section/v3:text" /></xsl:copy>
			</span>
				<br />


				<xsl:for-each select="v3:author/v3:assignedEntity/v3:representedOrganization/v3:assignedEntity/v3:assignedOrganization/v3:assignedEntity/v3:assignedOrganization/v3:id[@root='2.16.840.1.113883.3.989.5.1.4.1.35']">
				<!--<xsl:if test="v3:author/v3:assignedEntity/v3:representedOrganization/v3:assignedEntity/v3:assignedOrganization/v3:assignedEntity/v3:assignedOrganization/v3:id[@root='2.16.840.1.113883.3.989.5.1.4.1.35']/@extension !=''">-->
				<xsl:if test="@extension = '1'">
					<xsl:text> DIN Owner</xsl:text>
				</xsl:if>
				<xsl:if test="@extension = '2'">
					<xsl:text> Agent</xsl:text>
				</xsl:if>
				<xsl:if test="@extension = '3'">
					<xsl:text> Importer</xsl:text>
				</xsl:if>
				<xsl:if test="@extension = '4'">
					<xsl:text> Distributor</xsl:text>
				</xsl:if>
				<xsl:if test="@extension = '5'">
					<xsl:text> Previous DIN Owner</xsl:text>
				</xsl:if>
				<xsl:choose>
					<xsl:when test="position() != last()">, </xsl:when>
				</xsl:choose>
				...
				<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@displayName='Other Party Name']/v3:section/v3:text !=''">
				<p style="text-align:left; ">
			...
			<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@displayName='Other Party Address']/v3:section/v3:text !=''">
				<p style="text-align:left; ">
					<xsl:for-each select="v3:author/v3:assignedEntity/v3:representedOrganization/v3:assignedEntity[position() > 0]/v3:assignedOrganization/v3:assignedEntity/v3:assignedOrganization/v3:addr">
						<xsl:copy>
						<xsl:value-of select="v3:streetAddressLine"/>,
						<xsl:value-of select="v3:city"/>, <xsl:value-of select="v3:state"/>,
						<xsl:value-of select="v3:postalCode"/>,
				...
				<br />
				<br />
				<p style="text-align:left; "> <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='170']/v3:section/v3:code/@displayName" />:
				<xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='170']/v3:section/v3:text" /> </p>
				<br />
				<br />
				<br />
				<br />
				...
				<br />
				<xsl:copy>
					<xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='440']/v3:section/v3:code/@displayName" />
				</xsl:copy>
				<br/>

				<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='440']/v3:section/v3:text" >
					<xsl:copy>
						<xsl:apply-templates select="."/>
					</xsl:copy>
				</xsl:for-each>
				...
				<p style="text-align:center; text-decoration:underline; font-weight:bold;">
					<xsl:copy><xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:id/@root='c7391c3d-5f03-45de-a1c4-928b23f37d6a']/v3:section/v3:code[@code='480']/@displayName" /></xsl:copy> </p>
				<br />
				<br />
				<br />
				<br />
				...
				<span class="formHeadingTitle">
				<h1>
									<p style="text-align:left; text-transform:uppercase;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='20']/v3:section/v3:code/@displayName" />...................................<a href="#part1" style="padding-left:1em;">4</a></p>
				...
				<h2>
								...
								<p style="padding-left:2em;text-align:left; text-transform:uppercase; font-weight:bold;"> 1. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='190']/v3:section/v3:code/@displayName" />....................................................<a href="#1." style="padding-left:1em;">4</a></p>

				</h2>
				<h3>
					<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10']/v3:section/v3:text != ''">
					<p style="text-align:left; padding-left:5em;"> 1.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10']/v3:section/v3:code/@displayName" />................................................................................<a href="#1.1" style="padding-left:1.1em;">4</a></p>
				</xsl:if>
				</h3>
							<h4>
								<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-20']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:6em;"> 1.1.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-20']/v3:section/v3:code/@displayName" />.................................................................................<a href="#1.1.1" style="padding-left:1em;">4</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-10']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:6em;"> 1.2.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-10']/v3:section/v3:code/@displayName" />.................................................................................<a href="#1.2.2" style="padding-left:1em;">4</a></p>
							</xsl:if>
							</h4>
				<h2>
								<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='200']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase; font-weight:bold; padding-left:2em;"> 2. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='200']/v3:section/v3:code/@displayName" />.................................................................................<a href="#2." style="padding-left:1.1em;">4</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='210']/v3:section/v3:text !=''">
								<p style="text-align:left; text-transform:uppercase; font-weight:bold; padding-left:2em;"> 3. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='210']/v3:section/v3:code/@displayName" /> .......................................................<a href="#3." style="padding-left:1.1em;">5</a></p>
							</xsl:if>
								<p style="text-align:left; text-transform:uppercase; font-weight:bold; padding-left:2em;"> 4. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='240']/v3:section/v3:code/@displayName" />......................................................<a href="#4." style="padding-left:1.2em;">5</a></p>
				</h2>
				<h3>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-10']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 4.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-10']/v3:section/v3:title" />....................................................................<a href="#4.1" style="padding-left:1em;">5</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-20']/v3:section/v3:text !=''">
								<p style="text-align:left; padding-left:5em;"> 4.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-20']/v3:section/v3:title" />................................<a href="#4.2" style="padding-left:1em;">5</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-40']/v3:section/v3:text !=''">
								<p style="text-align:left; padding-left:5em;"> 4.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-40']/v3:section/v3:title" />................................................................................<a href="#4.3" style="padding-left:1.1em;">5</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50']/v3:section/v3:text !=''">
								<p style="text-align:left; padding-left:5em;"> 4.4 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50']/v3:section/v3:title" />.................................................................................<a href="#4.4" style="padding-left:1.1em;">5</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-30']/v3:section/v3:text !=''">
								<p style="text-align:left; padding-left:5em;"> 4.5 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-30']/v3:section/v3:title" />...................................................................................<a href="#4.5" style="padding-left:1.2em;">5</a></p>
							</xsl:if>
				</h3>
				<h2>

							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='250']/v3:section/v3:text !=''">
								<p style="text-transform:uppercase;padding-left:2em;"> 5. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='250']/v3:section/v3:code/@displayName" />.........................................................................................<a href="#5." style="padding-left:1.3em;">6</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='290']/v3:section/v3:text !=''">
								<p style="text-transform:uppercase;padding-left:2em;"> 6. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='290']/v3:section/v3:code/@displayName" /> ..................<a href="#6." style="padding-left:1.1em;">6</a></p>
							</xsl:if>
								<p style="padding-left:2em;text-align:left; text-transform:uppercase;"> 7. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='370']/v3:section/v3:code/@displayName" />........................................................<a href="#7." style="padding-left:1.1em;">6</a></p>
				</h2>
				<h3>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210']/v3:section/v3:text !=''">
								<p style="text-align:left; padding-left:5em;"> 7.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210']/v3:section/v3:title" />........................................................................<a href="#7.1" style="padding-left:1.3em;">8</a></p>
							</xsl:if>
				</h3>
				<h4>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-10']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:6em;"> 7.1.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-10']/v3:section/v3:code/@displayName" />.....................................................................<a href="#7.1.1" style="padding-left:1.3em;">8</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-20']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:6em;"> 7.1.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-20']/v3:section/v3:code/@displayName" />.......................................................................<a href="#7.1.2" style="padding-left:1.3em;">8</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-30']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:6em;"> 7.1.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-30']/v3:section/v3:code/@displayName" />.................................................................................<a href="#7.1.3" style="padding-left:1.1em;">8</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-40']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:6em;"> 7.1.4 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-40']/v3:section/v3:code/@displayName" />.................................................................................<a href="#7.1.4" style="padding-left:1.1em;">8</a></p>
							</xsl:if>
				</h4>
				<h3>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-220']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 7.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-220']/v3:section/v3:code/@displayName" />............................................................<a href="#7.2" style="padding-left:1.2em;">8</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-230']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 7.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-230']/v3:section/v3:code/@displayName" />...................................................<a href="#7.3" style="padding-left:1.2em;">8</a></p>
							</xsl:if>
				</h3>

				<h2>
								<p style="text-align:left; text-transform:uppercase; padding-left:2em;"> 8. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='220']/v3:section/v3:code/@displayName" />..........................................................................<a href="#8." style="padding-left:1.3em;">8</a></p>
				</h2>
				<h3>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-10']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 8.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-10']/v3:section/v3:code/@displayName" />.....................................<a href="#8.1" style="padding-left:1.35em;">8</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-20']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 8.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-20']/v3:section/v3:code/@displayName" />..........................................<a href="#8.2" style="padding-left:1.35em;">8</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-30']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 8.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-30']/v3:section/v3:code/@displayName" />..................<a href="#8.3" style="padding-left:1.3em;">9</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-40']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 8.4 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-40']/v3:section/v3:code/@displayName" />.............<a href="#8.4" style="padding-left:1.3em;">9</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-50']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 8.5 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-50']/v3:section/v3:code/@displayName" />............................................<a href="#8.6" style="padding-left:1.3em;">9</a></p>
							</xsl:if>
				</h3>
				<h2>
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 9. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='230']/v3:section/v3:code/@displayName" />..........................................................................<a href="#9." style="padding-left:1.4em;">9</a></p>
				</h2>
				<h3>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='230']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 9.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='230']/v3:section/v3:code/@displayName" />............................................................................<a href="#9.1" style="padding-left:1.3em;">9</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-80']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 9.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-80']/v3:section/v3:code/@displayName" />........................................................................................<a href="#9.2" style="padding-left:1.3em;">10</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-10']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 9.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-10']/v3:section/v3:code/@displayName" />..................................................................<a href="#9.3" style="padding-left:1.3em;">10</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-20']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 9.4 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-20']/v3:section/v3:code/@displayName" />..................................................................<a href="#9.4" style="padding-left:1.27em;">10</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-30']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 9.5 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-30']/v3:section/v3:code/@displayName" />..................................................................<a href="#9.5" style="padding-left:1.3em;">10</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-40']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 9.6 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-40']/v3:section/v3:code/@displayName" />........................................................<a href="#9.6" style="padding-left:1.3em;">10</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-50']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 9.7 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-50']/v3:section/v3:code/@displayName" />............................................................<a href="#9.7" style="padding-left:1.2em;">10</a></p>
							</xsl:if>
				</h3>

				<h2>
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 10. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='260']/v3:section/v3:code/@displayName" />................................<a href="#10." style="padding-left:1.2em;">10</a></p>
				</h2>
				<h3>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-10']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 10.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-10']/v3:section/v3:code/@displayName" />..................................................................<a href="#10.1" style="padding-left:1.3em;">10</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-20']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 10.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-20']/v3:section/v3:code/@displayName" />......................................................................<a href="#10.2" style="padding-left:1.2em;">11</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 10.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30']/v3:section/v3:code/@displayName" />.........................................................................<a href="#10.3" style="padding-left:1.2em;">11</a></p>
							</xsl:if>
				</h3>
				<h2>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='270']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 11. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='270']/v3:section/v3:code/@displayName" />...............................................................<a href="#11." style="padding-left:1.3em;">11</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='280']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 12. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='280']/v3:section/v3:code/@displayName" />...........................................<a href="#12." style="padding-left:1.35em;">11</a></p>
							</xsl:if>
				</h2>
				<h1>
								<p style="text-align:left; text-transform:uppercase;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='30']/v3:section/v3:code/@displayName" />.........................................................<a href="#part2" style="padding-left:1.4em;">12</a></p>
				</h1>
				<h2>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='300']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 13. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='300']/v3:section/v3:code/@displayName" />.............................................<a href="#13." style="padding-left:1.3em;">12</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='310']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 14. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='310']/v3:section/v3:code/@displayName" />...............................................................................<a href="#14." style="padding-left:1.3em;">12</a></p>
							</xsl:if>
				</h2>
				<h3>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:5em;"> 14.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10']/v3:section/v3:code/@displayName" />........................................................<a href="#14.1" style="padding-left:1.4em;">12</a></p>
							</xsl:if>
				</h3>
				<h4>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-10']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:6em;"> 14.1.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-10']/v3:section/v3:code/@displayName" />...................................<a href="#14.1.1" style="padding-left:1.3em;">12</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-20']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:6em;"> 14.1.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-20']/v3:section/v3:code/@displayName" />........................................................................<a href="#14.1.2" style="padding-left:1.4em;">12</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-20']/v3:section/v3:text != ''">
								<p style="text-align:left; padding-left:6em;"> 14.1.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-20']/v3:section/v3:code/@displayName" />.......................<a href="#14.1.3" style="padding-left:1.3em;">12</a></p>
							</xsl:if>
				</h4>
				<h2>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='320']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 15. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='320']/v3:section/v3:code/@displayName" />.........................................................<a href="#15." style="padding-left:1.3em;">14</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='330']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 16. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='330']/v3:section/v3:code/@displayName" />.................................................................................<a href="#16." style="padding-left:1.35em;">14</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='340']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 17. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='340']/v3:section/v3:code/@displayName" />......................................................................................<a href="#17." style="padding-left:1.4em;">14</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='350']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 18. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='350']/v3:section/v3:code/@displayName" />.......................................................................................<a href="#18." style="padding-left:1.4em;">14</a></p>
							</xsl:if>
				</h2>

				<h1>
								<p style="text-align:left; text-transform:uppercase"><xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='40']/v3:section/v3:code/@displayName" />.......................................................<a href="#part3" style="padding-left:1.35em;">14</a></p>
				</h1>
				<h2>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='490']/v3:section[v3:id/@root='be74b6e6-c431-4a5f-a18e-ed321b381456']/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 19. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='490']/v3:section[v3:id/@root='be74b6e6-c431-4a5f-a18e-ed321b381456']/v3:code/@displayName" />....................................................................<a href="#19." style="padding-left:1.4em;">14</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='360']/v3:section/v3:text !=''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 20. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='360']/v3:section/v3:code/@displayName" />.............................................................<a href="#20." style="padding-left:1.4em;">14</a></p>
							</xsl:if>
				</h2>
				<h3>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-10']/v3:section/v3:text != ''">
								<p style="text-align:left;padding-left:5em;"> 20.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-10']/v3:section/v3:code/@displayName" />.................................................<a href="#20.1" style="padding-left:1.35em;">15</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-20']/v3:section/v3:text != ''">
								<p style="text-align:left;padding-left:5em;"> 20.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-20']/v3:section/v3:code/@displayName" />................................................................................<a href="#20.2" style="padding-left:1.25em;">15</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-30']/v3:section/v3:text != ''">
								<p style="text-align:left;padding-left:5em;"> 20.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-30']/v3:section/v3:code/@displayName" />........................................................<a href="#20.3" style="padding-left:1.4em;">15</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-40']/v3:section/v3:text != ''">
								<p style="text-align:left;padding-left:5em;"> 20.4 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-40']/v3:section/v3:code/@displayName" />................................................<a href="#20.4" style="padding-left:1.3em;">15</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-50']/v3:section/v3:text != ''">
								<p style="text-align:left;padding-left:5em;"> 20.5 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-50']/v3:section/v3:code/@displayName" />......................<a href="#20.5" style="padding-left:1.2em;">15</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-60']/v3:section/v3:text != ''">
								<p style="text-align:left;padding-left:5em;"> 20.6 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-60']/v3:section/v3:code/@displayName" />...................................................<a href="#20.6" style="padding-left:1.15em;">15</a></p>
							</xsl:if>
				</h3>
				<h2>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='370']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 21. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='370']/v3:section/v3:code/@displayName" />.....................................................<a href="#21." style="padding-left:1em;">16</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='380']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 22. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='380']/v3:section/v3:code/@displayName" />.................................<a href="#22." style="padding-left:1.1em;">16</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='390']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 23. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='390']/v3:section/v3:code/@displayName" />.............................................<a href="#23." style="padding-left:1em;">16</a></p>
							</xsl:if>
				</h2>
				<h3>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-10']/v3:section/v3:text != ''">
								<p style="text-align:left;padding-left:5em;"> 23.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-10']/v3:section/v3:code/@displayName" />...................................................................................<a href="#23.1" style="padding-left:1.1em;">16</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-20']/v3:section/v3:text != ''">
								<p style="text-align:left;padding-left:5em;"> 23.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-20']/v3:section/v3:code/@displayName" />.....................................................................................<a href="#23.2" style="padding-left:1.2em;">16</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-30']/v3:section/v3:text != ''">
								<p style="text-align:left;padding-left:5em;"> 23.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-30']/v3:section/v3:code/@displayName" />................................................................................<a href="#23.3" style="padding-left:1.1em;">16</a></p>
							</xsl:if>
				</h3>
				<h2>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='400']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 24. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='400']/v3:section/v3:code/@displayName" />.....................<a href="#24." style="padding-left:1.05em;">17</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='410']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 25. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='410']/v3:section/v3:code/@displayName" />..............................................................................<a href="#25." style="padding-left:1.1em;">17</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='420']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 26. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='420']/v3:section/v3:code/@displayName" />.....................................<a href="#26." style="padding-left:1em;">17</a></p>
							</xsl:if>
							<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='430']/v3:section/v3:text != ''">
								<p style="text-align:left; text-transform:uppercase;padding-left:2em;"> 27. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='430']/v3:section/v3:code/@displayName" />........................................................................<a href="#27." style="padding-left:1em;">17</a></p>
							</xsl:if>
				</h2>
				...
				<h2>
								<p id="part1" style="font-size:1.25em; text-align:center; text-transform:uppercase;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='20']/v3:section/v3:code/@displayName" /></p>
				</h2>
								<br/>
								<br/>
								<p id="1." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 1. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='190']/v3:section/v3:code/@displayName" /> </p>

				<!-- End Jason/Jeffrey Addition -->
						...
						<xsl:otherwise>
							...
							<xsl:for-each select="v3:manufacturedProduct/*[self::v3:manufacturedProduct or self::v3:manufacturedMedicine]">
								<strong style="font-size:1.1em;">
									...
									(<xsl:value-of select="v3:name"/>) is indicated for:
								</strong>
							</xsl:for-each>
						</xsl:otherwise>
					</xsl:choose>
			...
			<!-- Jeffrey Addition - PART 1/PART I: HEALTH PROFESSIONAL INFORMATION -->

			<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10']/v3:section/v3:text != ''">
				<br/>
				<br/>
			<p id="1.1" style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 1.1  <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10']/v3:section/v3:code/@displayName" /> </p>
			<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10']/v3:section/v3:text" >
			<xsl:copy>
				<xsl:apply-templates select="."/>
			</xsl:copy>
		</xsl:for-each>
		...
		<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-20']/v3:section/v3:text != ''">
			<br/>
			<p id="1.1.1" style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 1.1.1  <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-20']/v3:section/v3:code/@displayName" /> </p>
			<p style="font-size:1.2em; text-align:left;">
				<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-20']/v3:section/v3:text" >
				<xsl:copy>
					<xsl:apply-templates select="."/>
				</xsl:copy>
			</xsl:for-each>
		...
		<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-10']/v3:section/v3:text != ''">
			<br/>
			<p id="1.2.2" style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 1.1.2  <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-10']/v3:section/v3:code/@displayName" /> </p>
			<p style="font-size:1.2em; text-align:left;">
			<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='190-10-10']/v3:section/v3:text" >
			<xsl:copy>
				<xsl:apply-templates select="."/>
			</xsl:copy>
		</xsl:for-each>
...
<br/>
<br/>
<p id="2." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 2.  <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='200']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='200']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
			...
			<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='370']/v3:section/v3:text !=''">
				...
				<br/>
				<br/>
			<p id="3." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 3. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='370']/v3:section/v3:code/@displayName" /> </p>

			<div style="padding: 10px; border: 1px solid black;">
				<p style="font-size:1.25em; text-align:center; font-weight:bold;">Serious Warnings and Precautions
				</p>


						<p style="font-size:1.25em; text-align:left;">

							<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='370']/v3:section/v3:text" >
							<xsl:copy>
								<xsl:apply-templates select="."/>
							</xsl:copy>
						</xsl:for-each>
			...
			<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='240']/v3:section/v3:text !=''">
				<br/>
				<br/>
				<br/>
			<p id="4." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 4. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='240']/v3:section/v3:code/@displayName" /> </p>
			<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='240']/v3:section/v3:text" >
			<xsl:copy>
				<xsl:apply-templates select="."/>
			</xsl:copy>
		</xsl:for-each>
			...
			<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-10']/v3:section/v3:text != ''">
				<br/>
			<p id="4.1" style="font-size:1.25em; text-align:left; font-weight:bold;"> 4.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-10']/v3:section/v3:code/@displayName" /></p>
						<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-10']/v3:section/v3:text" >
						<xsl:copy>
							<xsl:apply-templates select="."/>
						</xsl:copy>
					</xsl:for-each>
...
<br/>
			...
			<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-20']/v3:section/v3:text != '' ">
				<br/>
			<p id="4.2" style="font-size:1.25em; text-align:left; font-weight:bold;"> 4.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-20']/v3:section/v3:code/@displayName" /> </p>
						<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-20']/v3:section/v3:text" >
							<xsl:copy>
								<xsl:apply-templates select="."/>
							</xsl:copy>
						</xsl:for-each>
...
<br />
	<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-40']/v3:section/v3:text != ''">
		<br/>
	<p id="4.3" style="font-size:1.25em; text-align:left; font-weight:bold;"> 4.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-40']/v3:section/v3:code/@displayName" /> </p>
		<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-40']/v3:section/v3:text" />
</xsl:if>
<br />
<br/>
<xsl:if test="(v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50']/v3:section/v3:text != '') and
	(v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50-10']/v3:section/v3:text != '') and
	(v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50-20']/v3:section/v3:text != '')">

	<p id="4.4" style="font-size:1.25em; text-align:left; font-weight:bold;"> 4.4 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50']/v3:section/v3:code/@displayName" /> </p>
	<p style="font-size:1.1em;"><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50']/v3:section/v3:text" />

	<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50-10']/v3:section/v3:text != ''">
		<br/>
			Oral Solutions:
			<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50-10']/v3:section/v3:text" />
			<br/>
	</xsl:if>
	<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50-20']/v3:section/v3:text != ''">
		<br/>
			Parenteral Products:
			<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-50-20']/v3:section/v3:text" />
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-30']/v3:section/v3:text != ''">
	<br/>
	<br/>
	<p id="4.5" style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 4.5 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-30']/v3:section/v3:code/@displayName" /> </p>
	<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='240-30']/v3:section/v3:text" >
		<xsl:copy>
			<xsl:apply-templates select="."/>
		</xsl:copy>
	</xsl:for-each>
	...
	<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='250']/v3:section/v3:text != ''">
		...
		<br/>
		<br/>
	<p id="5." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 5. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='250']/v3:section/v3:code/@displayName" /> </p>

		<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='250']/v3:section/v3:text" >
		<xsl:copy>
			<xsl:apply-templates select="."/>
		</xsl:copy>
	</xsl:for-each>
...
<br/>
<br/>
	<p id="6." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 6. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='290']/v3:section/v3:code/@displayName" /> </p>
	<table style="padding: 5px;border: 1px solid black;
    border-collapse: collapse; width:100%; font-size:1.25em;">
  <tr style="border: 1px solid black;
    border-collapse: collapse;">
    <th style="border: 1px solid black;
    border-collapse: collapse;">Route of Administration</th>
    <th style="border: 1px solid black;
    border-collapse: collapse;">Dosage Form / Strength/Composition</th>
    <th style="border: 1px solid black;
    border-collapse: collapse;">Non-medicinal Ingredients</th>
  </tr>
  <tr>
    <td style="padding: 5px;border: 1px solid black;
    border-collapse: collapse;">
		<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:subject/v3:manufacturedProduct/v3:consumedIn/v3:substanceAdministration/v3:routeCode[@code='14']" >
			<xsl:copy>
				<xsl:value-of select="@displayName"/>
				<xsl:if test="position() != last()">,</xsl:if>
			</xsl:copy>
    ...
    <td style="padding: 5px;border: 1px solid black;
    border-collapse: collapse;">
		<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:formCode/@code='2']/v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:formCode">
		<xsl:copy>
			<xsl:value-of select="@displayName"/>
			<xsl:if test="position() != last()">,</xsl:if>
		</xsl:copy>
		...
		<td style="padding: 5px;border: 1px solid black;
    border-collapse: collapse;">
		<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:subject/v3:manufacturedProduct/v3:manufacturedProduct/v3:ingredient[@classCode='IACT']/v3:ingredientSubstance/v3:name">
...
<br/>
<br/>
<p id="7." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 7. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='370']/v3:section/v3:code/@displayName" /> </p>
<p style="font-size:1.25em">
	Please see the <a href="#3.">Serious Warnings and Precautions Box</a> at the beginning of Part I: Health Professional Information </p>
</xsl:if>


<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-10']/v3:section/v3:text !=''" >
<p style="font-size:1.1em; font-weight:bold; text-align:left;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-10']/v3:section/v3:code/@displayName" /> </p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-10']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-20']/v3:section/v3:text !=''" >
<p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-20']/v3:section/v3:code/@displayName" />
 </p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-20']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-30']/v3:section/v3:text !=''" >
<p style="font-size:1.1em; text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-30']/v3:section/v3:code/@displayName" />
 </p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-30']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-40']/v3:section/v3:text !=''" >
<p style="font-size:1.1em; text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-40']/v3:section/v3:code/@displayName" />
 </p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-40']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-50']/v3:section/v3:text !=''" >
<p style="font-size:1.1em; text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-50']/v3:section/v3:code/@displayName" />
 </p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-50']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-60']/v3:section/v3:text !=''" >
<p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-60']/v3:section/v3:code/@displayName" />
 </p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-60']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-70']/v3:section/v3:text !=''" >
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-70']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-70']/v3:section/v3:text" >
	 <xsl:copy>
	 	<xsl:apply-templates select="."/>
	 </xsl:copy>
	 </xsl:for-each>
 ...
 <xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-80']/v3:section/v3:text !=''" >
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-80']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-80']/v3:section/v3:text" >
 <xsl:copy>
 	<xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
 ...
 <xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-90']/v3:section/v3:text !=''" >
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-90']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-90']/v3:section/v3:text" >
	 <xsl:copy>
	 	<xsl:apply-templates select="."/>
	 </xsl:copy>
	 </xsl:for-each>
 ...
 <xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-100']/v3:section/v3:text !=''" >
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-100']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-100']/v3:section/v3:text" >
	 <xsl:copy>
	 	<xsl:apply-templates select="."/>
	 </xsl:copy>
 </xsl:for-each></p>
 ...
 <xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-110']/v3:section/v3:text !=''" >
 <p style="font-size:1.1em; text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-110']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-110']/v3:section/v3:text" >
	 <xsl:copy>
	 	<xsl:apply-templates select="."/>
	 </xsl:copy>
	 </xsl:for-each>
 ...
 <xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-230']/v3:section/v3:text !=''" >
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-230']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-230']/v3:section/v3:text" >
 <xsl:copy>
 	<xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-120']/v3:section/v3:text !=''">
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select=" v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-120']/v3:section/v3:code/@displayName" /></p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-120']/v3:section/v3:text">
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-130']/v3:section/v3:text !=''">
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-130']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-130']/v3:section/v3:text" >
	 <xsl:copy>
	 	<xsl:apply-templates select="."/>
	 </xsl:copy>
	 </xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-140']/v3:section/v3:text !=''">
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-140']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-140']/v3:section/v3:text" >
 <xsl:copy>
 	<xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
 ...
 <xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-150']/v3:section/v3:text !=''">
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-150']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-150']/v3:section/v3:text" >
 <xsl:copy>
 	<xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
 ...
 <xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-160']/v3:section/v3:text !=''">
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-160']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-160']/v3:section/v3:text" >
 <xsl:copy>
 	<xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
	...
	<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-170']/v3:section/v3:text !=''">
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-170']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-170']/v3:section/v3:text" >
 <xsl:copy>
	 <xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-180']/v3:section/v3:text !=''">
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-180']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-180']/v3:section/v3:text" >
 <xsl:copy>
 	<xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-190']/v3:section/v3:text !=''">
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-190']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-190']/v3:section/v3:text" >
 <xsl:copy>
	 <xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-200']/v3:section/v3:text !=''">
 <p style="font-size:1.1em;text-align:left; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-200']/v3:section/v3:code/@displayName" />
  </p>
 <p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-200']/v3:section/v3:text" >
 <xsl:copy>
 	<xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
...
<br/>
<br/>
 <p id="7.1" style="font-size: 1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 7.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210']/v3:section/v3:code/@displayName" /> </p>
</xsl:if>


<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-10']/v3:section/v3:text != ''">

 <p id="7.1.1" style="font-size:1.25em; text-align:left; font-weight:bold;"> 7.1.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-10']/v3:section/v3:code/@displayName" /> </p>
 <xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-10']/v3:section/v3:text" >
 <xsl:copy>
 	<xsl:apply-templates select="."/>
 </xsl:copy>
 </xsl:for-each>
...
<br/>
<br/>
 <p id="7.1.2" style="font-size:1.25em; text-align:left; font-weight:bold;"> 7.1.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-20']/v3:section/v3:code/@displayName" /> </p>

	<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-20']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<br/>
<br/>
<p id="7.1.3" style="font-size:1.25em; text-align:left; font-weight:bold;"> 7.1.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-30']/v3:section/v3:code/@displayName" /> </p>
<xsl:choose>
	<xsl:when test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-30']/v3:section/v3:text != ''" >
		<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-30']/v3:section/v3:text" >
		<xsl:copy>
			<xsl:apply-templates select="."/>
		</xsl:copy>
		</xsl:for-each>
	...
	<xsl:otherwise>
		<p style="font-size:1.25em;"><strong>Pediatrics &lt;(age range)&gt; </strong>: No data available to Health Canada; therefore, Health Canada has not authoried an indication for pediatric use.</p>
</xsl:otherwise>
</xsl:choose>
</xsl:if>
...
<br/>
<br/>
<p id="7.1.4" style="font-size:1.25em; text-align:left; font-weight:bold;"> 7.1.4
<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-40']/v3:section/v3:code/@displayName" />
</p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-210-40']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="7.2" style="font-size:1.25em; text-align:left; font-weight:bold;"> 7.2
<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-220']/v3:section/v3:code/@displayName" />
</p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-220']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="7.3" style="font-size:1.25em; text-align:left; font-weight:bold;"> 7.3
<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-230']/v3:section/v3:code/@displayName" />
</p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='210-230']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='220']/v3:section/v3:text != ''">
<br/>
<br/>
<br/>
<br/>
<p id="8." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 8. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='220']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='220']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="8.1" style="font-size:1.25em; text-align:left; font-weight:bold;"> 8.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-10']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-10']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="8.2" style="font-size:1.25em; text-align:left; font-weight:bold;"> 8.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-20']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-20']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="8.3" style="font-size:1.25em; text-align:left; font-weight:bold;"> 8.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-30']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-30']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="8.4" style="font-size:1.25em; text-align:left; font-weight:bold;"> 8.4 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-40']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-40']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="8.6" style="font-size:1.25em; text-align:left; font-weight:bold;"> 8.5 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-50']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='220-50']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="9." style="font-size:1.25em; text-align:left; font-weight:bold;"> 9. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='230']/v3:section/v3:code/@displayName" /></p>
</xsl:if>

<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='230']/v3:section/v3:text !=''">
<br/>
<p id="9.1" style="font-size:1.25em; text-align:left; font-weight:bold;"> 9.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='230']/v3:section/v3:code/@displayName" /></p>
<div style="padding:5px;border: 1px solid black;">
	<p style="font-size:1.25em; text-align:center; font-weight:bold;">Serious Drug Interactions
	</p>
			<p>
				<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='230']/v3:section/v3:text" >
				<xsl:copy>
					<xsl:apply-templates select="."/>
				</xsl:copy>
			</xsl:for-each>
...
<br/>
<br/>
<p id="9.2" style="font-size:1.25em; text-align:left; font-weight:bold;"> 9.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-80']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-80']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="9.3" style="font-size:1.25em; text-align:left; font-weight:bold;"> 9.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-10']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-10']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="9.4" style="font-size:1.25em; text-align:left; font-weight:bold;"> 9.4 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-20']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-20']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="9.5" style="font-size:1.25em; text-align:left; font-weight:bold;"> 9.5 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-30']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-30']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="9.6" style="font-size:1.25em; text-align:left; font-weight:bold;"> 9.6 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-40']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-40']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="9.7" style="font-size:1.25em; text-align:left; font-weight:bold;"> 9.7 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-50']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='230-50']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='260']/v3:section/v3:text != ''">
<br/>
<br/>
<br/>
<br/>
<p id="10." style="text-transform:uppercase;font-size:1.25em; text-align:left; font-weight:bold;"> 10. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='260']/v3:section/v3:code/@displayName" /></p>
</xsl:if>

<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-10']/v3:section/v3:text != ''">
<br/>
<p id="10.1" style="font-size:1.25em; text-align:left; font-weight:bold;"> 10.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-10']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-10']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-20']/v3:section/v3:text != ''">
<br/>
<p id="10.2" style="font-size:1.25em; text-align:left; font-weight:bold;"> 10.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-20']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-20']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="10.3" style="font-size:1.25em; text-align:left; font-weight:bold;"> 10.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-10']/v3:section/v3:text != ''">
<br/>
<p style="font-size:1.1em;"><strong><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-10']/v3:section/v3:code/@displayName" />: </strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-10']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-20']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-20']/v3:section/v3:code/@displayName" />: </strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-20']/v3:section/v3:text">
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-30']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-30']/v3:section/v3:code/@displayName" />: </strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-30']/v3:section/v3:text">
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-40']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-40']/v3:section/v3:code/@displayName" />: </strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-40']/v3:section/v3:text">
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50']/v3:section/v3:code/@displayName" />: </strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50']/v3:section/v3:text">
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-10']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><i><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-10']/v3:section/v3:code/@displayName" />: </i></strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-10']/v3:section/v3:text">
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-20']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><i><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-20']/v3:section/v3:code/@displayName" />: </i></strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-20']/v3:section/v3:text">
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-30']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><i><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-30']/v3:section/v3:code/@displayName" />: </i></strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-30']/v3:section/v3:text">
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-40']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><i><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-40']/v3:section/v3:code/@displayName" />: </i></strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-40']/v3:section/v3:text">
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-50']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><i><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-50']/v3:section/v3:code/@displayName" />: </i></strong>
<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-50']/v3:section/v3:text"/>
</p>
</xsl:if>

<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-60']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><i><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-60']/v3:section/v3:code/@displayName" />: </i></strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-60']/v3:section/v3:text">
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-70']/v3:section/v3:text != ''">
<p style="font-size:1.1em;"><strong><i><xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-70']/v3:section/v3:code/@displayName" />: </i></strong>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='260-30-50-70']/v3:section/v3:text">
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="11." style="text-transform:uppercase; font-size:1.25em; text-align:left; font-weight:bold;"> 11. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='270']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='270']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="12." style="text-transform: uppercase; font-size:1.25em; text-align:left; font-weight:bold;"> 12. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='280']/v3:section/v3:code/@displayName" /></p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='280']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="part2" style="text-transform:uppercase;font-size:1.25em; text-align: center; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='30']/v3:section/v3:code/@displayName" /> </p>

<p id="13." style="text-transform:uppercase; font-size:1.25em; text-align:left;"> <strong>13. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='300']/v3:section/v3:code/@displayName" /></strong></p>
<br/>
<xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='280']/v3:section/v3:text" />
<br/>
<br/>
<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10']/v3:section/v3:code/@displayName" />:
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
<br/> <br/>
<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-10']/v3:section/v3:code/@displayName" />:
<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-10']/v3:section/v3:text" />

<p>
	<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-20']/v3:section/v3:code/@displayName" />:
	<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-20']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<p>
	<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-30']/v3:section/v3:code/@displayName" />:
	<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-30']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<p>
	<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-40']/v3:section/v3:code/@displayName" />:
	<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-40']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<p>
	<xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-50']/v3:section/v3:code/@displayName" />:
	<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='300-10-50']/v3:section/v3:text" >
		<xsl:copy>
			<xsl:apply-templates select="."/>
		</xsl:copy>
		</xsl:for-each>
...
<br/>
<br/>
<p id="14." style="text-transform:uppercase;font-weight: bold;font-size:1.25em; text-align:left;"> 14. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='310']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='310']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10']/v3:section/v3:text != ''">
<br/>
<p id="14.1" style="font-weight:bold;font-size:1.25em;">14.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10']/v3:section/v3:code/@displayName" /></p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each></p>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-10']/v3:section/v3:text != ''">
<br/>
<p id="14.1.1" style="font-weight:bold;font-size:1.25em;">14.1.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-10']/v3:section/v3:code/@displayName" /></p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-10']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-20']/v3:section/v3:text != ''">
<br/>
<p id="14.1.2" style="font-weight:bold;font-size:1.25em;">14.1.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-20']/v3:section/v3:code/@displayName" /></p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-10-20']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-20']/v3:section/v3:text != ''">
<br/>
<p id="14.1.3" style="font-weight:bold;font-size:1.25em;">14.1.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-20']/v3:section/v3:code/@displayName" /></p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component/v3:section/v3:component[v3:section/v3:code/@code='310-20']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="15." style="text-transform:uppercase;font-weight: bold;font-size:1.25em; text-align:left;">15. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='320']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='320']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="16." style="text-transform:uppercase;font-weight: bold;font-size:1.25em; text-align:left;">16. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='330']/v3:section/v3:code/@displayName" /> </p>
<!--<xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='330']/v3:section/v3:text" />-->
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='330']/v3:section/v3:text" >
<xsl:copy>
<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each></p>
...
<br/>
<br/>
<p id="17." style="text-transform:uppercase;font-weight: bold;font-size:1.25em; text-align:left;">17. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='340']/v3:section/v3:code/@displayName" /> </p>
	<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='340']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="18." style="text-transform:uppercase;font-weight: bold;font-size:1.25em; text-align:left;">18. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='350']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='350']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<p id="part3" style="text-transform:uppercase;font-size:1.25em; text-align: center; font-weight:bold;"> <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='40']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='480']/v3:section[v3:id/@root='be74b6e6-c431-4a5f-a18e-ed321b381456']/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="19." style="text-transform:uppercase;font-weight: bold;font-size:1.25em; text-align:left;">19. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='490']/v3:section[v3:id/@root='be74b6e6-c431-4a5f-a18e-ed321b381456']/v3:code/@displayName" /> </p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='490']/v3:section[v3:id/@root='be74b6e6-c431-4a5f-a18e-ed321b381456']/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each></p>
...
<br/>
<br/>
<p id="20." style="text-transform:uppercase;font-weight: bold;font-size:1.25em; text-align:left;">20. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='360']/v3:section/v3:code/@displayName" /> </p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='360']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each></p>
...
<br/>
<br/>
<p id="20.1" style="font-weight: bold;font-size:1.25em; text-align:left;">20.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-10']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-10']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<p id="20.2" style="font-weight: bold;font-size:1.25em; text-align:left;">20.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-20']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-20']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-30']/v3:section/v3:text != ''">
<br/>
<p id="20.3" style="font-weight: bold;font-size:1.25em; text-align:left;">20.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-30']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-30']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<p id="20.4" style="font-weight: bold;font-size:1.25em; text-align:left;">20.4 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-40']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-40']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-50']/v3:section/v3:text != ''">
<br/>
<p id="20.5" style="font-weight: bold;font-size:1.25em; text-align:left;">20.5 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-50']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-50']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-60']/v3:section/v3:text != ''">
<br/>
<p id="20.6" style="font-weight: bold;font-size:1.25em; text-align:left;">20.6 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-60']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='360-60']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="21." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 21. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='370']/v3:section/v3:code/@displayName" /> </p>
<div style="padding:5px;border: 1px solid black;">
	<p style="font-size:1.25em; text-align:center; font-weight:bold;">Serious Warnings and Precautions
	</p>
...
<br/>
<br/>
<p id="22." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 22. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='380']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='380']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='390']/v3:section/v3:text !=''">
	<br/>
	<br/>
<p id="23." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 23. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='390']/v3:section/v3:code/@displayName" /> </p>
<p style="font-size:1.1em;"><xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='390']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each></p>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-10']/v3:section/v3:text != ''">
	<br/>
	<br/>
<p id="23.1" style="font-size:1.25em; text-align:left; font-weight:bold;"> 23.1 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-10']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-10']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-20']/v3:section/v3:text != ''">
	<br/>
<p id="23.2" style="font-size:1.25em; text-align:left; font-weight:bold;"> 23.2 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-20']/v3:section/v3:code/@displayName" /> </p>
<div style="padding: 5px;border: 1px solid black;">
	<br/>
	<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-20']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<xsl:if test="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-30']/v3:section/v3:text != ''">
	<br/>
<p id="23.3" style="font-size:1.25em; text-align:left; font-weight:bold;"> 23.3 <xsl:value-of select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-30']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component/v3:section/v3:component[v3:section/v3:code/@code='390-30']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="24." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 24. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='400']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='400']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="25." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 25. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='410']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='410']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p id="26." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 26. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='420']/v3:section/v3:code/@displayName" /> </p>
	<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='420']/v3:section/v3:text" >
	<xsl:copy>
		<xsl:apply-templates select="."/>
	</xsl:copy>
	</xsl:for-each>
...
<br/>
<br/>
<p id="27." style="font-size:1.25em; text-align:left; text-transform:uppercase; font-weight:bold;"> 27. <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='430']/v3:section/v3:code/@displayName" /> </p>
<xsl:for-each select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='430']/v3:section/v3:text" >
<xsl:copy>
	<xsl:apply-templates select="."/>
</xsl:copy>
</xsl:for-each>
...
<br/>
<br/>
<p> Revision Date: <xsl:value-of select="v3:component/v3:structuredBody/v3:component[v3:section/v3:code/@code='470']/v3:section/v3:text" />
</p>


			<!-- End Jeffrey Addition -->
