<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  xmlns:verb="http://informatik.hu-berlin.de/xml-verbatimatim" version="2.0"
...
-->
  ...
  <xsl:template name="xml-verbatim-setup">
    ...
    <script type="text/javascript" src="{$resourcesdir}xml-verbatim.js"/>
  </xsl:template>
  ...
  <xsl:template match="/" mode="xml-verbatim">
    ...
    <div class="xml-verbatim-default" onclick="xmlVerbatimClick(event);"
